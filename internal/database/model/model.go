// Package model defines the database models and data structures used by the radpanel panel.
package model
...
// User represents a user account in the radpanel panel.
type User struct {
...
// Setting stores key-value configuration settings for the radpanel panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote radpanel panel registered with the central panel.

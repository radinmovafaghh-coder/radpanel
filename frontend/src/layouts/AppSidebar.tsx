...
const REPO_URL = 'https://github.com/radinmovafaghh-coder/radpanel';
    ...
    >
      ...
      >
        <div className="sider-brand">
          <div className="brand-block">
            <span className="brand-text">{railCollapsed ? 'RP' : 'RadPanel'}</span>
          </div>
          {!railCollapsed && (
      ...
      >
        <div className="drawer-header">
          <div className="brand-block">
            <span className="drawer-brand">RadPanel</span>
          </div>

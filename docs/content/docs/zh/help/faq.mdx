---
title: 常见问题
description: 关于 radpanel 的常见问题 —— 许可协议、受支持的系统、数据库以及客户端。
icon: CircleQuestionMark
---

## radpanel 是免费且开源的吗？

是的。radpanel 基于 GPL-3.0 许可协议开源，源代码托管在
[GitHub](https://github.com/radinmovafaghh-coder/radpanel) 上。
...
## radpanel 与 radpanel 有什么区别？

radpanel 是原版 X-UI 项目的增强分支。它增加了更广泛的协议支持、更佳的稳定性、
...
[发布页面](https://github.com/radinmovafaghh-coder/radpanel/releases)。

## 我可以在哪里获取帮助？

加入官方 Telegram 频道 [@XrayUI](https://t.me/XrayUI) 获取公告与社区支持，
或在 [GitHub](https://github.com/radinmovafaghh-coder/radpanel/issues) 上提交 issue。遇到常见问题时，

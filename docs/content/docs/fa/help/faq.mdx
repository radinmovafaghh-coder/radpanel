---
title: سؤالات متداول
description: پرسش‌های پرتکرار درباره radpanel — مجوز، سیستم‌های پشتیبانی‌شده، پایگاه‌های داده و کلاینت‌ها.
icon: CircleQuestionMark
---

## آیا radpanel رایگان و متن‌باز است؟

بله. radpanel تحت مجوز GPL-3.0 متن‌باز است. کد منبع آن روی
[GitHub](https://github.com/radinmovafaghh-coder/radpanel) در دسترس است.
...
## radpanel چه تفاوتی با radpanel دارد؟

radpanel یک فورک ارتقایافته از پروژه اصلی X-UI است. این پروژه پشتیبانی گسترده‌تری از
...
[صفحه نسخه‌ها](https://github.com/radinmovafaghh-coder/radpanel/releases) مراجعه کنید.
...
[GitHub](https://github.com/radinmovafaghh-coder/radpanel/issues) باز کنید. برای مشکلات رایج، با

---
title: پراکسی معکوس
description: قرار دادن پنل و اشتراک radpanel پشت Nginx یا Caddy همراه با TLS از Let's Encrypt.
icon: Waypoints
---
...
[منوی SSL در `radpanel`](/docs/config/ssl-certificates) دریافت کنید.

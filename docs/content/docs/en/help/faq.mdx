---
title: FAQ
description: Frequently asked questions about radpanel — licensing, supported systems, databases, and clients.
icon: CircleQuestionMark
---

## Is radpanel free and open source?

Yes. radpanel is open source under the GPL-3.0 license. The source is on
[GitHub](https://github.com/radinmovafaghh-coder/radpanel).
...
## How is radpanel different from radpanel?

radpanel is an enhanced fork of the original X-UI project. It adds broader protocol
...
[releases page](https://github.com/radinmovafaghh-coder/radpanel/releases).
...
[GitHub](https://github.com/radinmovafaghh-coder/radpanel/issues). For common problems, start

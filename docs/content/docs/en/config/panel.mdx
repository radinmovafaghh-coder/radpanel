...
description: Every radpanel panel setting — web server, TLS, display, security, and notifications — with defaults from the source.
...
`webCertFile` + `webKeyFile` — the [`radpanel` SSL menu](/docs/config/ssl-certificates)

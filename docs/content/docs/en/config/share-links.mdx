---
title: Share Links
description: radpanel share-link formats (vless, vmess, trojan, ss, hysteria2, mtproto), the remark template variables, and an in-browser link inspector.
icon: Link
---

radpanel generates a **share link** (and QR code) for each client. Client apps such

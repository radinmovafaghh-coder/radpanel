---
title: Telegram Bot
description: Connect a Telegram bot to radpanel for commands, periodic reports, event alerts (login, CPU, node up/down), backups, and client self-service.
icon: Send
---

radpanel can drive a Telegram bot for monitoring, alerts, backups, and remote

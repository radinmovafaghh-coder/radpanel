---
title: API Reference
description: The radpanel panel REST API — authentication, inbounds, clients, server stats, and more, generated from the OpenAPI spec.
icon: Webhook
---

The radpanel panel exposes a REST API for automation. These pages are generated from

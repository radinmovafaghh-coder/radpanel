...
Para la documentación completa —instalación, configuración, operación y la referencia completa de la API— visita **[docs/](docs/)**.
...
La lista completa está en la [docs/](docs/).
